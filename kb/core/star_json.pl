...
:- dynamic star_evidence_locator/3.
:- dynamic star_evidence_contradicts/3.
:- dynamic star_evidence_corroborates/3.
:- dynamic star_relation/9.
:- dynamic star_relation_unresolved_endpoint/4.
:- dynamic star_inverse_predicate/3.
:- dynamic star_relation_qualifier/3.

% Generated projections group facts per document, so clauses of the dynamic
% predicates above are intentionally discontiguous in loaded projection files.
:- discontiguous
    star_json_object/2, star_json_array/3, star_json_member/4, star_json_index/4,
    star_json_value/4, star_doc/6, star_projection_input_hash/3, star_profile/5,
    star_ref/3, star_time/4, star_provenance/9, star_source/7, star_evidence/7,
    star_evidence_locator/3, star_evidence_contradicts/3, star_evidence_corroborates/3,
    star_relation/9, star_relation_unresolved_endpoint/4, star_inverse_predicate/3,
    star_relation_qualifier/3.
